...
class Registry:
    ...
    def build(self, args, *cfg, **kwargs):
        return self.build_func(args, *cfg, **kwargs, registry=self)
...
def build_from_cfg(args, cfg, registry, default_args=None):
